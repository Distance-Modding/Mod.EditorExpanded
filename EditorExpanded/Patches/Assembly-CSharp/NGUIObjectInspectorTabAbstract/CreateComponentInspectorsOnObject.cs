...
namespace EditorExpanded.Patches
{
	...
	{
		[HarmonyPrefix]
		internal static bool Prefix(NGUIObjectInspectorTabAbstract __instance, ref DontInspectComponents.Set ignoreList, ref bool objectSupportsUndo, ref UnityEngine.GameObject obj)
		{
