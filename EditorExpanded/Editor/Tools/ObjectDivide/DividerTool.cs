    ...
    public class DividerTool : InstantTool
    {
        ...
        public override bool Run()
        {
            ...
            if (!IsGameObjNull(tabSystemUIRoot) && !doesIsPresent)
            {
                ...
                if (IsGameObjNull(searchBar)) Mod.Log.LogInfo("BLARRR");
                ...
                if (IsGameObjNull(intInput)) Mod.Log.LogInfo("BLARRR");
        ...
        {
            Mod.Log.LogInfo("<PROPS>");
            Mod.Log.LogInfo("cursorPosition: " + comp.cursorPosition);
            Mod.Log.LogInfo("defaultText: " + comp.defaultText);
            Mod.Log.LogInfo("Dragging_: " + comp.Dragging_);
            Mod.Log.LogInfo("enabled: " + comp.enabled);
            Mod.Log.LogInfo("ExpStepSize_: " + comp.ExpStepSize_);
            Mod.Log.LogInfo("hideFlags: " + comp.hideFlags);
            Mod.Log.LogInfo("isSelected: " + comp.isSelected);
            Mod.Log.LogInfo("Max_: " + comp.Max_);
            Mod.Log.LogInfo("Min_: " + comp.Min_);
            //Mod.Logger.Info("enabled: " + comp.selected);
            Mod.Log.LogInfo("selectionEnd: " + comp.selectionEnd);
            Mod.Log.LogInfo("selectionStart: " + comp.selectionStart);
            Mod.Log.LogInfo("StepSize_: " + comp.StepSize_);
            Mod.Log.LogInfo("tag: " + comp.tag);
            //Mod.Logger.Info("enabled: " + comp.text);
            Mod.Log.LogInfo("useGUILayout: " + comp.useGUILayout);
            Mod.Log.LogInfo("value: " + comp.value);
            Mod.Log.LogInfo("Value_: " + comp.Value_);
            Mod.Log.LogInfo("<FIELDS>");
            Mod.Log.LogInfo("activeTextColor: " + comp.activeTextColor);
            Mod.Log.LogInfo("caretColor: " + comp.caretColor);
            Mod.Log.LogInfo("characterLimit: " + comp.characterLimit);
            Mod.Log.LogInfo("customString_: " + comp.customString_);
            Mod.Log.LogInfo("dragDelta_: " + comp.dragDelta_);
            Mod.Log.LogInfo("expressionTree_: " + comp.expressionTree_);
            Mod.Log.LogInfo("expStepSize_: " + comp.expStepSize_);
            Mod.Log.LogInfo("facadeButton_: " + comp.facadeButton_);
            Mod.Log.LogInfo("hideInput: " + comp.hideInput);
            Mod.Log.LogInfo("ignoreNextInputOnChangeEvent_: " + comp.ignoreNextInputOnChangeEvent_);
            Mod.Log.LogInfo("inactiveColor_: " + comp.inactiveColor_);
            Mod.Log.LogInfo("inputType: " + comp.inputType);
            Mod.Log.LogInfo("keyboardType: " + comp.keyboardType);
            Mod.Log.LogInfo("label: " + comp.label);
            Mod.Log.LogInfo("max_: " + comp.max_);
            Mod.Log.LogInfo("min_: " + comp.min_);
            Mod.Log.LogInfo("onChange: " + comp.onChange);
            Mod.Log.LogInfo("onChange_: " + comp.onChange_);
            Mod.Log.LogInfo("onFinish_: " + comp.onFinish_);
            Mod.Log.LogInfo("onReturnKey: " + comp.onReturnKey);
            Mod.Log.LogInfo("onStart_: " + comp.onStart_);
            Mod.Log.LogInfo("onSubmit: " + comp.onSubmit);
            Mod.Log.LogInfo("onValidate: " + comp.onValidate);
            Mod.Log.LogInfo("openedKeyboard_: " + comp.openedKeyboard_);
            Mod.Log.LogInfo("previousValue_: " + comp.previousValue_);
            Mod.Log.LogInfo("savedAs: " + comp.savedAs);
            Mod.Log.LogInfo("selectAllTextOnFocus: " + comp.selectAllTextOnFocus);
            Mod.Log.LogInfo("selectionColor: " + comp.selectionColor);
            Mod.Log.LogInfo("selectOnSubmit_: " + comp.selectOnSubmit_);
            Mod.Log.LogInfo("selectOnTab: " + comp.selectOnTab);
            Mod.Log.LogInfo("stepSize_: " + comp.stepSize_);
            Mod.Log.LogInfo("submitted_: " + comp.submitted_);
            Mod.Log.LogInfo("touchID_: " + comp.touchID_);
            Mod.Log.LogInfo("validation: " + comp.validation);
            Mod.Log.LogInfo("value_: " + comp.value_);
            Mod.Log.LogInfo("<FIELDSM>");
            Mod.Log.LogInfo("mBlankTex: " + comp.mBlankTex);
            Mod.Log.LogInfo("mCached: " + comp.mCached);
            Mod.Log.LogInfo("mCam: " + comp.mCam);
            Mod.Log.LogInfo("mCaret: " + comp.mCaret);
            Mod.Log.LogInfo("mDefaultColor: " + comp.mDefaultColor);
            Mod.Log.LogInfo("mDefaultText: " + comp.mDefaultText);
            Mod.Log.LogInfo("mDoInit: " + comp.mDoInit);
            Mod.Log.LogInfo("mHighlight: " + comp.mHighlight);
            Mod.Log.LogInfo("mLastAlpha: " + comp.mLastAlpha);
            Mod.Log.LogInfo("mLoadSavedValue: " + comp.mLoadSavedValue);
            Mod.Log.LogInfo("mNextBlink: " + comp.mNextBlink);
            Mod.Log.LogInfo("mOnGUI: " + comp.mOnGUI);
            Mod.Log.LogInfo("mPivot: " + comp.mPivot);
            Mod.Log.LogInfo("mPosition: " + comp.mPosition);
            Mod.Log.LogInfo("mSelectionEnd: " + comp.mSelectionEnd);
            Mod.Log.LogInfo("mSelectionStart: " + comp.mSelectionStart);
            Mod.Log.LogInfo("mSelectMe: " + comp.mSelectMe);
            Mod.Log.LogInfo("mSelectTime: " + comp.mSelectTime);
            Mod.Log.LogInfo("mValue: " + comp.mValue);
        }
        ...
        private void printPropsAndFields(UIToggle comp)
        {
            ...
            Mod.Log.LogInfo("value: " + comp.value);
            Mod.Log.LogInfo("<FIELDS>");
            Mod.Log.LogInfo("activeAnimation: " + comp.activeAnimation);
            Mod.Log.LogInfo("activeSprite: " + comp.activeSprite);
            Mod.Log.LogInfo("animator: " + comp.animator);
            Mod.Log.LogInfo("checkAnimation: " + comp.checkAnimation);
            Mod.Log.LogInfo("checkSprite: " + comp.checkSprite);
            Mod.Log.LogInfo("eventReceiver: " + comp.eventReceiver);
            Mod.Log.LogInfo("functionName: " + comp.functionName);
            Mod.Log.LogInfo("group: " + comp.group);
            Mod.Log.LogInfo("instantTween: " + comp.instantTween);
            Mod.Log.LogInfo("mIsActive: " + comp.mIsActive);
            Mod.Log.LogInfo("mStarted: " + comp.mStarted);
            Mod.Log.LogInfo("onChange: " + comp.onChange);
            Mod.Log.LogInfo("optionCanBeNone: " + comp.optionCanBeNone);
            Mod.Log.LogInfo("startsActive: " + comp.startsActive);
            Mod.Log.LogInfo("startsChecked: " + comp.startsChecked);
            Mod.Log.LogInfo("validator: " + comp.validator);
        }
        ...
        private void printPropsAndFields(UIExDisableOnSelect comp)
        {
            ...
            Mod.Log.LogInfo("enabled: " + comp.enabled);
            Mod.Log.LogInfo("hideFlags: " + comp.hideFlags);
            Mod.Log.LogInfo("isActiveAndEnabled: " + comp.isActiveAndEnabled);
            Mod.Log.LogInfo("tag: " + comp.tag);
            Mod.Log.LogInfo("useGUILayout: " + comp.useGUILayout);
            Mod.Log.LogInfo("<FIELDS>");
            Mod.Log.LogInfo("deactivateOnSelect_: " + comp.deactivateOnSelect_);
            Mod.Log.LogInfo("disableButtonsOnSelect_: " + comp.disableButtonsOnSelect_);
            Mod.Log.LogInfo("disableOnSelect_: " + comp.disableOnSelect_);
        ...
        {
            Mod.Log.LogInfo("<PROPS>");
            Mod.Log.LogInfo("alignment: " + comp.alignment);
            Mod.Log.LogInfo("alpha: " + comp.alpha);
            Mod.Log.LogInfo("ambigiousFont: " + comp.ambigiousFont);
            Mod.Log.LogInfo("applyGradient: " + comp.applyGradient);
            Mod.Log.LogInfo("bitmapFont: " + comp.bitmapFont);
            Mod.Log.LogInfo("border: " + comp.border);
            Mod.Log.LogInfo("color: " + comp.color);
            Mod.Log.LogInfo("depth: " + comp.depth);
            Mod.Log.LogInfo("drawRegion: " + comp.drawRegion);
            Mod.Log.LogInfo("effectColor: " + comp.effectColor);
            Mod.Log.LogInfo("effectDistance: " + comp.effectDistance);
            Mod.Log.LogInfo("effectStyle: " + comp.effectStyle);
            Mod.Log.LogInfo("enabled: " + comp.enabled);
            Mod.Log.LogInfo("floatSpacingX: " + comp.floatSpacingX);
            Mod.Log.LogInfo("floatSpacingY: " + comp.floatSpacingY);
            //Mod.Logger.Info("enabled: " + comp.font);
            Mod.Log.LogInfo("fontSize: " + comp.fontSize);
            Mod.Log.LogInfo("fontStyle: " + comp.fontStyle);
            Mod.Log.LogInfo("gradientBottom: " + comp.gradientBottom);
            Mod.Log.LogInfo("gradientTop: " + comp.gradientTop);
            Mod.Log.LogInfo("height: " + comp.height);
            Mod.Log.LogInfo("hideFlags: " + comp.hideFlags);
            //Mod.Logger.Info("enabled: " + comp.lineHeight);
            //Mod.Logger.Info("enabled: " + comp.lineWidth);
            Mod.Log.LogInfo("mainTexture: " + comp.mainTexture);
            Mod.Log.LogInfo("material: " + comp.material);
            Mod.Log.LogInfo("maxLineCount: " + comp.maxLineCount);
            Mod.Log.LogInfo("multiLine: " + comp.multiLine);
            Mod.Log.LogInfo("onRender: " + comp.onRender);
            Mod.Log.LogInfo("overflowMethod: " + comp.overflowMethod);
            Mod.Log.LogInfo("pivot: " + comp.pivot);
            Mod.Log.LogInfo("rawPivot: " + comp.rawPivot);
            Mod.Log.LogInfo("shader: " + comp.shader);
            Mod.Log.LogInfo("shouldBeProcessed: " + comp.shouldBeProcessed);
            //Mod.Logger.Info("enabled: " + comp.shrinkToFit);
            Mod.Log.LogInfo("spacingX: " + comp.spacingX);
            Mod.Log.LogInfo("spacingY: " + comp.spacingY);
            Mod.Log.LogInfo("supportEncoding: " + comp.supportEncoding);
            Mod.Log.LogInfo("symbolStyle: " + comp.symbolStyle);
            Mod.Log.LogInfo("tag: " + comp.tag);
            Mod.Log.LogInfo("text: " + comp.text);
            Mod.Log.LogInfo("trueTypeFont: " + comp.trueTypeFont);
            Mod.Log.LogInfo("useFloatSpacing: " + comp.useFloatSpacing);
            Mod.Log.LogInfo("useGUILayout: " + comp.useGUILayout);
            Mod.Log.LogInfo("width: " + comp.width);
            Mod.Log.LogInfo("<FIELDS>");
            Mod.Log.LogInfo("aspectRatio: " + comp.aspectRatio);
            Mod.Log.LogInfo("autoResizeBoxCollider: " + comp.autoResizeBoxCollider);
            Mod.Log.LogInfo("bottomAnchor: " + comp.bottomAnchor);
            Mod.Log.LogInfo("drawCall: " + comp.drawCall);
            Mod.Log.LogInfo("fillGeometry: " + comp.fillGeometry);
            Mod.Log.LogInfo("finalAlpha: " + comp.finalAlpha);
            Mod.Log.LogInfo("geometry: " + comp.geometry);
            Mod.Log.LogInfo("hideIfOffScreen: " + comp.hideIfOffScreen);
            Mod.Log.LogInfo("hitCheck: " + comp.hitCheck);
            Mod.Log.LogInfo("keepAspectRatio: " + comp.keepAspectRatio);
            Mod.Log.LogInfo("keepCrispWhenShrunk: " + comp.keepCrispWhenShrunk);
            Mod.Log.LogInfo("leftAnchor: " + comp.leftAnchor);
            Mod.Log.LogInfo("onChange: " + comp.onChange);
            Mod.Log.LogInfo("onPostFill: " + comp.onPostFill);
            Mod.Log.LogInfo("panel: " + comp.panel);
            Mod.Log.LogInfo("rightAnchor: " + comp.rightAnchor);
            Mod.Log.LogInfo("topAnchor: " + comp.topAnchor);
            Mod.Log.LogInfo("updateAnchors: " + comp.updateAnchors);
            Mod.Log.LogInfo("<FIELDSM>");
            Mod.Log.LogInfo("mActiveTTF: " + comp.mActiveTTF);
            Mod.Log.LogInfo("mAlignment: " + comp.mAlignment);
            Mod.Log.LogInfo("mAlphaFrameID: " + comp.mAlphaFrameID);
            Mod.Log.LogInfo("mAnchorsCached: " + comp.mAnchorsCached);
            Mod.Log.LogInfo("mApplyGradient: " + comp.mApplyGradient);
            Mod.Log.LogInfo("mCalculatedSize: " + comp.mCalculatedSize);
            Mod.Log.LogInfo("mCam: " + comp.mCam);
            Mod.Log.LogInfo("mChanged: " + comp.mChanged);
            Mod.Log.LogInfo("mChildren: " + comp.mChildren);
            Mod.Log.LogInfo("mColor: " + comp.mColor);
            Mod.Log.LogInfo("mCorners: " + comp.mCorners);
            Mod.Log.LogInfo("mDensity: " + comp.mDensity);
            Mod.Log.LogInfo("mDepth: " + comp.mDepth);
            Mod.Log.LogInfo("mDrawRegion: " + comp.mDrawRegion);
            Mod.Log.LogInfo("mEffectColor: " + comp.mEffectColor);
            Mod.Log.LogInfo("mEffectDistance: " + comp.mEffectDistance);
            Mod.Log.LogInfo("mEffectStyle: " + comp.mEffectStyle);
            Mod.Log.LogInfo("mEncoding: " + comp.mEncoding);
            Mod.Log.LogInfo("mFinalFontSize: " + comp.mFinalFontSize);
            Mod.Log.LogInfo("mFloatSpacingX: " + comp.mFloatSpacingX);
            Mod.Log.LogInfo("mFloatSpacingY: " + comp.mFloatSpacingY);
            Mod.Log.LogInfo("mFont: " + comp.mFont);
            Mod.Log.LogInfo("mFontSize: " + comp.mFontSize);
            Mod.Log.LogInfo("mFontStyle: " + comp.mFontStyle);
            Mod.Log.LogInfo("mGo: " + comp.mGo);
            Mod.Log.LogInfo("mGradientBottom: " + comp.mGradientBottom);
            Mod.Log.LogInfo("mGradientTop: " + comp.mGradientTop);
            Mod.Log.LogInfo("mHeight: " + comp.mHeight);
            Mod.Log.LogInfo("mIsInFront: " + comp.mIsInFront);
            Mod.Log.LogInfo("mIsVisibleByAlpha: " + comp.mIsVisibleByAlpha);
            Mod.Log.LogInfo("mIsVisibleByPanel: " + comp.mIsVisibleByPanel);
            Mod.Log.LogInfo("mLastAlpha: " + comp.mLastAlpha);
            Mod.Log.LogInfo("mLastHeight: " + comp.mLastHeight);
            Mod.Log.LogInfo("mLastWidth: " + comp.mLastWidth);
            Mod.Log.LogInfo("mLineWidth: " + comp.mLineWidth);
            Mod.Log.LogInfo("mLocalToPanel: " + comp.mLocalToPanel);
            Mod.Log.LogInfo("mMaterial: " + comp.mMaterial);
            Mod.Log.LogInfo("mMatrixFrame: " + comp.mMatrixFrame);
            Mod.Log.LogInfo("mMaxLineCount: " + comp.mMaxLineCount);
            Mod.Log.LogInfo("mMaxLineHeight: " + comp.mMaxLineHeight);
            Mod.Log.LogInfo("mMaxLineWidth: " + comp.mMaxLineWidth);
            Mod.Log.LogInfo("mMoved: " + comp.mMoved);
            Mod.Log.LogInfo("mMultiline: " + comp.mMultiline);
            Mod.Log.LogInfo("mOldV0: " + comp.mOldV0);
            Mod.Log.LogInfo("mOldV1: " + comp.mOldV1);
            Mod.Log.LogInfo("mOnRender: " + comp.mOnRender);
            Mod.Log.LogInfo("mOverflow: " + comp.mOverflow);
            Mod.Log.LogInfo("mOverflowEllipsis: " + comp.mOverflowEllipsis);
            Mod.Log.LogInfo("mParent: " + comp.mParent);
            Mod.Log.LogInfo("mParentFound: " + comp.mParentFound);
            Mod.Log.LogInfo("mPivot: " + comp.mPivot);
            Mod.Log.LogInfo("mPlayMode: " + comp.mPlayMode);
            Mod.Log.LogInfo("mPremultiply: " + comp.mPremultiply);
            Mod.Log.LogInfo("mProcessedText: " + comp.mProcessedText);
            Mod.Log.LogInfo("mRoot: " + comp.mRoot);
            Mod.Log.LogInfo("mRootSet: " + comp.mRootSet);
            Mod.Log.LogInfo("mScale: " + comp.mScale);
            Mod.Log.LogInfo("mShouldBeProcessed: " + comp.mShouldBeProcessed);
            Mod.Log.LogInfo("mShrinkToFit: " + comp.mShrinkToFit);
            Mod.Log.LogInfo("mSpacingX: " + comp.mSpacingX);
            Mod.Log.LogInfo("mSpacingY: " + comp.mSpacingY);
            Mod.Log.LogInfo("mStarted: " + comp.mStarted);
            Mod.Log.LogInfo("mSymbols: " + comp.mSymbols);
            Mod.Log.LogInfo("mText: " + comp.mText);
            Mod.Log.LogInfo("mTrans: " + comp.mTrans);
            Mod.Log.LogInfo("mTrueTypeFont: " + comp.mTrueTypeFont);
            Mod.Log.LogInfo("mUpdateAnchors: " + comp.mUpdateAnchors);
            Mod.Log.LogInfo("mUpdateFrame: " + comp.mUpdateFrame);
            Mod.Log.LogInfo("mUseFloatSpacing: " + comp.mUseFloatSpacing);
            Mod.Log.LogInfo("mWidth: " + comp.mWidth);
        ...
        private void printPropsAndFields(UIButton comp)
        {
            ...
            Mod.Log.LogInfo("enabled: " + comp.enabled);
            Mod.Log.LogInfo("hideFlags: " + comp.hideFlags);
            Mod.Log.LogInfo("isEnabled: " + comp.isEnabled);
            Mod.Log.LogInfo("normalSprite: " + comp.normalSprite);
            Mod.Log.LogInfo("normalSprite2D: " + comp.normalSprite2D);
            Mod.Log.LogInfo("state: " + comp.state);
            Mod.Log.LogInfo("tag: " + comp.tag);
            Mod.Log.LogInfo("useGUILayout: " + comp.useGUILayout);
            Mod.Log.LogInfo("<FIELDS>");
            Mod.Log.LogInfo("disabledColor: " + comp.disabledColor);
            Mod.Log.LogInfo("disabledSprite: " + comp.disabledSprite);
            Mod.Log.LogInfo("disabledSprite2D: " + comp.disabledSprite2D);
            Mod.Log.LogInfo("dragHighlight: " + comp.dragHighlight);
            Mod.Log.LogInfo("duration: " + comp.duration);
            Mod.Log.LogInfo("hover: " + comp.hover);
            Mod.Log.LogInfo("hoverSprite: " + comp.hoverSprite);
            Mod.Log.LogInfo("hoverSprite2D: " + comp.hoverSprite2D);
            Mod.Log.LogInfo("onClick: " + comp.onClick);
            Mod.Log.LogInfo("pixelSnap: " + comp.pixelSnap);
            Mod.Log.LogInfo("pressed: " + comp.pressed);
            Mod.Log.LogInfo("pressedSprite: " + comp.pressedSprite);
            Mod.Log.LogInfo("pressedSprite2D: " + comp.pressedSprite2D);
            Mod.Log.LogInfo("tweenTarget: " + comp.tweenTarget);
            Mod.Log.LogInfo("<FIELDSM>");
            Mod.Log.LogInfo("mDefaultColor: " + comp.mDefaultColor);
            Mod.Log.LogInfo("mInitDone: " + comp.mInitDone);
            Mod.Log.LogInfo("mNormalSprite: " + comp.mNormalSprite);
            Mod.Log.LogInfo("mNormalSprite2D: " + comp.mNormalSprite2D);
            Mod.Log.LogInfo("mSprite: " + comp.mSprite);
            Mod.Log.LogInfo("mSprite2D: " + comp.mSprite2D);
            Mod.Log.LogInfo("mStartingColor: " + comp.mStartingColor);
            Mod.Log.LogInfo("mState: " + comp.mState);
            Mod.Log.LogInfo("mWidget: " + comp.mWidget);
        }
        ...
        private void printPropsAndFields(UIWidget comp)
        {
            ...
            Mod.Log.LogInfo("hideFlags: " + comp.hideFlags);
            Mod.Log.LogInfo("mainTexture: " + comp.mainTexture);
            Mod.Log.LogInfo("name: " + comp.name);
            Mod.Log.LogInfo("onRender: " + comp.onRender);
            Mod.Log.LogInfo("pivot: " + comp.pivot);
            Mod.Log.LogInfo("rawPivot: " + comp.rawPivot);
            Mod.Log.LogInfo("shader: " + comp.shader);
        ...
        private void printPropsAndFields(UISprite comp)
        {
            Mod.Log.LogInfo("<PROPS>");
            Mod.Log.LogInfo("alpha: " + comp.alpha);
            Mod.Log.LogInfo("atlas: " + comp.atlas);
            Mod.Log.LogInfo("color: " + comp.color);
            Mod.Log.LogInfo("depth: " + comp.depth);
            Mod.Log.LogInfo("drawRegion: " + comp.drawRegion);
            Mod.Log.LogInfo("enabled: " + comp.enabled);
            Mod.Log.LogInfo("fillAmount: " + comp.fillAmount);
            Mod.Log.LogInfo("centerType: " + comp.centerType);
            Mod.Log.LogInfo("fillDirection: " + comp.fillDirection);
            Mod.Log.LogInfo("flip: " + comp.flip);
            Mod.Log.LogInfo("height: " + comp.height);
            Mod.Log.LogInfo("hideFlags: " + comp.hideFlags);
            Mod.Log.LogInfo("invert: " + comp.invert);
            Mod.Log.LogInfo("mainTexture: " + comp.mainTexture);
            Mod.Log.LogInfo("name: " + comp.name);
            Mod.Log.LogInfo("onRender: " + comp.onRender);
            Mod.Log.LogInfo("pivot: " + comp.pivot);
            Mod.Log.LogInfo("rawPivot: " + comp.rawPivot);
            Mod.Log.LogInfo("shader: " + comp.shader);
            Mod.Log.LogInfo("spriteName: " + comp.spriteName);
            Mod.Log.LogInfo("tag: " + comp.tag);
            Mod.Log.LogInfo("type: " + comp.type);
            Mod.Log.LogInfo("useGUILayout: " + comp.useGUILayout);
            Mod.Log.LogInfo("width: " + comp.width);
            Mod.Log.LogInfo("<FIELDS>");
            Mod.Log.LogInfo("aspectRatio: " + comp.aspectRatio);
            Mod.Log.LogInfo("autoResizeBoxCollider: " + comp.autoResizeBoxCollider);
            Mod.Log.LogInfo("bottomAnchor: " + comp.bottomAnchor);
            Mod.Log.LogInfo("bottomType: " + comp.bottomType);
            Mod.Log.LogInfo("centerType: " + comp.centerType);
            Mod.Log.LogInfo("drawCall: " + comp.drawCall);
            Mod.Log.LogInfo("fillGeometry: " + comp.fillGeometry);
            Mod.Log.LogInfo("finalAlpha: " + comp.finalAlpha);
            ...
            Mod.Log.LogInfo("keepAspectRatio: " + comp.keepAspectRatio);
            Mod.Log.LogInfo("leftAnchor: " + comp.leftAnchor);
            Mod.Log.LogInfo("leftType: " + comp.leftType);
            Mod.Log.LogInfo("onChange: " + comp.onChange);
            Mod.Log.LogInfo("onPostFill: " + comp.onPostFill);
            Mod.Log.LogInfo("panel: " + comp.panel);
            Mod.Log.LogInfo("rightAnchor: " + comp.rightAnchor);
            Mod.Log.LogInfo("rightType: " + comp.rightType);
            Mod.Log.LogInfo("topAnchor: " + comp.topAnchor);
            Mod.Log.LogInfo("topType: " + comp.topType);
            Mod.Log.LogInfo("updateAnchors: " + comp.updateAnchors);
            Mod.Log.LogInfo("<M>");
            Mod.Log.LogInfo("mAlphaFrameID: " + comp.mAlphaFrameID);
            Mod.Log.LogInfo("mAnchorsCached: " + comp.mAnchorsCached);
            Mod.Log.LogInfo("mAtlas: " + comp.mAtlas);
            Mod.Log.LogInfo("mCam: " + comp.mCam);
            Mod.Log.LogInfo("mChanged: " + comp.mChanged);
            Mod.Log.LogInfo("mChildren: " + comp.mChildren);
            Mod.Log.LogInfo("mColor: " + comp.mColor);
            ...
            Mod.Log.LogInfo("mDepth: " + comp.mDepth);
            Mod.Log.LogInfo("mDrawRegion: " + comp.mDrawRegion);
            Mod.Log.LogInfo("mFillAmount: " + comp.mFillAmount);
            Mod.Log.LogInfo("mFillCenter: " + comp.mFillCenter);
            Mod.Log.LogInfo("mFillDirection: " + comp.mFillDirection);
            Mod.Log.LogInfo("mFlip: " + comp.mFlip);
            Mod.Log.LogInfo("mGo: " + comp.mGo);
            Mod.Log.LogInfo("mHeight: " + comp.mHeight);
            Mod.Log.LogInfo("mInnerUV: " + comp.mInnerUV);
            Mod.Log.LogInfo("mInvert: " + comp.mInvert);
            Mod.Log.LogInfo("mIsInFront: " + comp.mIsInFront);
            Mod.Log.LogInfo("mIsVisibleByAlpha: " + comp.mIsVisibleByAlpha);
            Mod.Log.LogInfo("mIsVisibleByPanel: " + comp.mIsVisibleByPanel);
            Mod.Log.LogInfo("mLastAlpha: " + comp.mLastAlpha);
            ...
            Mod.Log.LogInfo("mOldV1: " + comp.mOldV1);
            Mod.Log.LogInfo("mOnRender: " + comp.mOnRender);
            Mod.Log.LogInfo("mOuterUV: " + comp.mOuterUV);
            Mod.Log.LogInfo("mParent: " + comp.mParent);
            Mod.Log.LogInfo("mParentFound: " + comp.mParentFound);
            Mod.Log.LogInfo("mPivot: " + comp.mPivot);
            Mod.Log.LogInfo("mPlayMode: " + comp.mPlayMode);
            ...
            Mod.Log.LogInfo("mRootSet: " + comp.mRootSet);
            Mod.Log.LogInfo("mSprite: " + comp.mSprite);
            Mod.Log.LogInfo("mSpriteName: " + comp.mSpriteName);
            Mod.Log.LogInfo("mSpriteSet: " + comp.mSpriteSet);
            Mod.Log.LogInfo("mStarted: " + comp.mStarted);
            Mod.Log.LogInfo("mTrans: " + comp.mTrans);
            Mod.Log.LogInfo("mType: " + comp.mType);
            Mod.Log.LogInfo("mUpdateAnchors: " + comp.mUpdateAnchors);
            Mod.Log.LogInfo("mUpdateFrame: " + comp.mUpdateFrame);
            Mod.Log.LogInfo("mWidth: " + comp.mWidth);
        }
        ...
        {
            Mod.Log.LogInfo("<BB>");
            Mod.Log.LogInfo("attachedRigidbody: " + comp.attachedRigidbody);
            Mod.Log.LogInfo("bounds: " + comp.bounds);
            Mod.Log.LogInfo("center: " + comp.center);
            Mod.Log.LogInfo("contactOffset: " + comp.contactOffset);
            Mod.Log.LogInfo("enabled: " + comp.enabled);
            //Mod.Log.LogInfo("alpha: " + comp.extents);
            Mod.Log.LogInfo("hideFlags: " + comp.hideFlags);
            Mod.Log.LogInfo("isTrigger: " + comp.isTrigger);
            Mod.Log.LogInfo("material: " + comp.material);
            Mod.Log.LogInfo("name: " + comp.name);
            Mod.Log.LogInfo("sharedMaterial: " + comp.sharedMaterial);
            Mod.Log.LogInfo("size: " + comp.size);
            Mod.Log.LogInfo("tag: " + comp.tag);
            Mod.Log.LogInfo("transform: " + comp.transform);
        }
